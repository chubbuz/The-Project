            ...
            <div class="single_post_content_left">
              <ul class="business_catgnav  wow fadeInDown">
                ...
                <li>
                  ...
                  <figure class="bsbig_fig"> <a href="pages/single_page.html" class="featured_img"> <img alt="" > <span class="overlay"></span> </a>
      ...
      <div class="col-lg-4 col-md-4 col-sm-4">
        <aside class="right_content">
          <div class="single_sidebar">
            <h2><span>धेरै पढिएको dherai</span></h2>
            <ul class="spost_nav">
              ...
              <li>
                <div class="media wow fadeInDown"> <a href="pages/single_page.html" class="media-left"> <img alt="" src="images/post_img1.jpg"> </a>
                  <div class="media-body"> <a href="pages/single_page.html" class="catg_title"> {{$news->title}}</div>
                </div>
              </li>
          ...
          <div class="single_sidebar wow fadeInDown">
            ...
            <a class="sideAdd" href="#"><img src="images/add_img.jpg" alt="Cartoon Image"></a> </div>
